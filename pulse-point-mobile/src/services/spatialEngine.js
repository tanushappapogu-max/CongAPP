// Legacy deterministic spatial helper. App.js does not import this module;
// any future use must remain an explicit demo-only path and must not be used
// as an automatic fallback for production/server detection.
